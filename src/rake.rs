...
pub fn rake(document: Vec<&str>) -> HashMap<String, f32> {
...
pub fn all_rake(corpus: Vec<Vec<&str>>) -> HashMap<usize, HashMap<String, f32>> {
  let mut all_rake_scores: HashMap<usize, HashMap<String, f32>> = HashMap::new();
